        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-slate-400 mb-6 line-clamp-2">
              {filteredNews.find(item => item.id === showShareMenu)?.title}
            </p>
            <div className="flex items-center justify-center mb-4">
              <button
                onClick={() => handleShareLinkedIn(filteredNews.find(item => item.id === showShareMenu))}
                className="w-20 h-20 bg-[#0077B5] hover:bg-[#006396] rounded-xl transition flex items-center justify-center group"
